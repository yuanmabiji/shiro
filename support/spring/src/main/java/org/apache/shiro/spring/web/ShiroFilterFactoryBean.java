...
// TODO 因为之前是在DelegatingFilterProxy的initFilterBean方法里面通过getBean方法吊起ShiroFilterFactoryBean的getObject方法来创建SpringShiroFilter实例；
// TODO 2,ShiroFilter为啥要交给DelegatingFilterProxy代理呢？由Spring统一管理？这里不太明白。
